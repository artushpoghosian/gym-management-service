...
public class TrainingEndpoint {
    ...
    public ResponseEntity<Void> addTraining(
        ...
        Trainee trainee = gymFacade.findTraineeByUsername(requestDto.getTraineeUsername())
                .orElseThrow(() -> new ValidationException("Trainee not found for username: " + requestDto.getTraineeUsername()));

        Trainer trainer = gymFacade.findTrainerByUsername(requestDto.getTrainerUsername())
